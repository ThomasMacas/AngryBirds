...
public class NormalLevel extends JPanel implements Level {
    ...
    public NormalLevel(int width, int height, LevelObjects levelObjects, ActionListener levelListener, User user) {
        ...
        // set actionListener to act when the end of game is reached
        this.levelListener = levelListener;

        // assign user to track score
        this.user = user;

        this.levelObjects = levelObjects;

        // Add the background to the JPanel
        ImageIcon bg = new ImageIcon("./Images/NormalLevel.png");
        ...
        this.bird.setBounds(100, 200, 40, 40);
        this.add(bird);
    ...
    public static void main(String[] args) {
        ...
        NormalLevel normallevel = new NormalLevel(800, 500, levelObjects, null, null);
        jFrame.add(normallevel);
