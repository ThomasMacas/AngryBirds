...
public class EasyLevel extends JPanel implements Level {
    ...
    public EasyLevel(int width, int height, LevelObjects levelObjects, ActionListener levelListener, User user) {
        ...
        ImageIcon bg = new ImageIcon("./Images/EasyLevel.jpeg");
    ...
    public static void main(String[] args) {
        ...
        EasyLevel easyLevel = new EasyLevel(800, 500, levelObjects, null, null);
        jFrame.add(easyLevel);
